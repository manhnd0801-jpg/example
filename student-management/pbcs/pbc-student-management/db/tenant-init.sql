-- AI-GENERATED
-- Tenant initialization script cho pbc-student-management
...
BEGIN
  ...
  -- Không cần seed dữ liệu mặc định cho student — sinh viên được tạo thủ công
  RAISE NOTICE 'pbc-student-management: tenant % initialized successfully', v_tenant_id;
END $;
