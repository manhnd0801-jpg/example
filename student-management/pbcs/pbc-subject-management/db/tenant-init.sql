-- AI-GENERATED
-- Tenant initialization script cho pbc-subject-management
...
BEGIN
  ...
  -- Không cần seed dữ liệu mặc định cho subject — môn học được tạo thủ công
  RAISE NOTICE 'pbc-subject-management: tenant % initialized successfully', v_tenant_id;
END $;
