-- AI-GENERATED
-- Tenant initialization script cho pbc-class-management
...
BEGIN
  ...
  -- Không cần seed dữ liệu mặc định cho class — lớp học được tạo thủ công
  RAISE NOTICE 'pbc-class-management: tenant % initialized successfully', v_tenant_id;
END $;
